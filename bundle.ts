...
var require_proto_list = __commonJS((exports, module) => {
  ...
  ProtoList.prototype = {
    ...
    set: function(key2, val, save) {
      if (!this.length)
        this.push({});
      if (save && this.list[0].hasOwnProperty(key2))
        this.push({});
      return this.list[0][key2] = val;
    },
    forEach: function(fn, thisp) {
      for (var key2 in this.list[0])
        fn.call(thisp, key2, this.list[0][key2]);
    },
    slice: function() {
...
var require_config_chain = __commonJS((exports, module) => {
  ...
  var parse = exports.parse = function(content, file, type2) {
    content = "" + content;
    if (!type2) {
      try {
  ...
  ConfigChain.prototype.del = function(key2, where) {
    if (where) {
  ...
  ConfigChain.prototype.get = function(key2, where) {
    if (where) {
      ...
      if (where)
        where = where.data;
      if (where && Object.hasOwnProperty.call(where, key2))
        return where[key2];
      return;
    }
    return this.list[0][key2];
  ...
  ConfigChain.prototype.addFile = function(file, type2, name2) {
    name2 = name2 || file;
    var marker = { __source__: name2 };
    this.sources[name2] = { path: file, type: type2 };
    this.push(marker);
    this._await();
  ...
  ConfigChain.prototype.addUrl = function(req, type2, name2) {
    this._await();
    var href = url.format(req);
    name2 = name2 || href;
    var marker = { __source__: name2 };
    this.sources[name2] = { href, type: type2 };
    this.push(marker);
    http.request(req, function(res) {
      var c = [];
      var ct = res.headers["content-type"];
      if (!type2) {
        type2 = ct.indexOf("json") !== -1 ? "json" : ct.indexOf("ini") !== -1 ? "ini" : href.match(/\.json$/) ? "json" : href.match(/\.ini$/) ? "ini" : null;
        marker.type = type2;
      }
      res.on("data", c.push.bind(c)).on("end", function() {
        this.addString(Buffer.concat(c), href, type2, marker);
  ...
  ConfigChain.prototype.addString = function(data, file, type2, marker) {
    data = this.parse(data, file, type2);
...
var require_util = __commonJS((exports) => {
  ...
  var parseField = (field, key2) => {
    if (typeof field !== "string") {
      return field;
    }
    const typeList = [].concat(types[key2]);
...
var require_content_disposition = __commonJS((exports, module) => {
  ...
  var ContentDisposition = function(type2, parameters) {
    this.type = type2;
...
var require_pify = __commonJS((exports, module) => {
  ...
  var pify = module.exports = function(obj, P, opts) {
    ...
    return Object.keys(obj).reduce(function(ret2, key2) {
      var x = obj[key2];
      ret2[key2] = typeof x === "function" && filter(key2) ? processFn(x, P, opts) : x;
      return ret2;
    }, ret);
  };
  pify.all = pify;
...
var require_query_string = __commonJS((exports) => {
      ...
      case "bracket":
        return function(key2, value, accumulator) {
          ...
          if (!result) {
            accumulator[key2] = value;
            return;
          } else if (accumulator[key2] === undefined) {
            accumulator[key2] = [value];
            return;
          }
  ...
  exports.stringify = function(obj, opts) {
    ...
    return obj ? Object.keys(obj).sort(opts.sort).map(function(key2) {
      var val = obj[key2];
      if (val === undefined) {
        return "";
      }
  ...
  module.exports = (obj, opts) => {
    ...
    const sortKeys = (x) => {
      ...
      for (let i = 0;i < keys.length; i++) {
        ...
        ret[key2] = deep && isPlainObj(val) ? sortKeys(val) : val;
      }
      return ret;
    };
    return sortKeys(obj);
  ...
  class CacheableRequest {
    ...
    createCacheableRequest(request) {
      return (opts, cb) => {
        ...
        const makeRequest = (opts2) => {
          ...
          const handler = (response) => {
            ...
            if (opts2.cache && response.cachePolicy.storable()) {
              ...
              this.cache.delete(key2).catch((err) => ee.emit("error", new CacheableRequest.CacheError(err)));
            }
        ...
        const get = (opts2) => Promise.resolve().then(() => opts2.cache ? this.cache.get(key2) : undefined).then((cacheEntry) => {
...
var require_dist = __commonJS((exports, module) => {
  ...
  var util = import.meta.require("util");
  var toString = Object.prototype.toString;
  var isOfType = (type2) => (value) => typeof value === type2;
  ...
  (function(is2) {
    ...
    const isFunctionOfType = (type2) => (value) => is2.function_(value) && is2.function_(value.constructor) && value.constructor.name === type2;
...
var require_got = __commonJS((exports, module) => {
  ...
  var normalizeArguments = function(url, opts) {
    ...
    for (const key2 of Object.keys(headers)) {
      if (is.nullOrUndefined(headers[key2])) {
        delete headers[key2];
      }
    }
...
var require_file_type6 = __commonJS((exports, module) => {
  ...
  module.exports = (input) => {
    ...
    if (check([26, 69, 223, 163])) {
      ...
      if (idPos !== -1) {
        const docTypePos = idPos + 3;
        const findDocType = (type2) => [...type2].every((c, i) => sliced[docTypePos + i] === c.charCodeAt(0));
        if (findDocType("matroska")) {
          return {
            ext: "mkv",
            mime: "video/x-matroska"
  ...
  var normalize2 = function(repo) {
    ...
    if (match) {
      ...
      if (origin == null) {
        if (type2 === "github") {
          origin = "github.com";
        } else if (type2 === "gitlab") {
          origin = "gitlab.com";
        } else if (type2 === "bitbucket") {
...
var getSignalsByName = () => {
  const signals4 = getSignals();
  return Object.fromEntries(signals4.map(getSignalByName));
};
var getSignalByName = ({
  name: name2,
  number,
...
var getSignalsByNumber = () => {
  ...
  const signalsA = Array.from({ length }, (value, number) => getSignalByNumber(number, signals4));
  return Object.assign({}, ...signalsA);
};
var getSignalByNumber = (number, signals4) => {
  const signal = findSignalByNumber(number, signals4);
  if (signal === undefined) {
    return {};
  }
...
var findSignalByNumber = (number, signals4) => {
  const signal = signals4.find(({ name: name2 }) => constants2.signals[name2] === number);
  if (signal !== undefined) {
    return signal;
  }
  return signals4.find((signalA) => signalA.number === number);
};
  ...
  parse(argsInput, options) {
      ...
      if (arg !== "--" && /^-/.test(arg) && isUnknownOptionAsArg(arg)) {
        ...
        if (m !== null && Array.isArray(m) && m.length >= 2) {
          ...
          if (checkAllAliases(key2, flags.arrays)) {
            ...
            next = args[i + 1];
            if (next !== undefined && (!next.match(/^-/) || next.match(negative)) && !checkAllAliases(key2, flags.bools) && !checkAllAliases(key2, flags.counts)) {
              setArg(key2, next);
              i++;
        ...
        if (m !== null && Array.isArray(m) && m.length >= 2) {
          key2 = m[1];
          if (next !== undefined && !next.match(/^-/) && !checkAllAliases(key2, flags.bools) && !checkAllAliases(key2, flags.counts)) {
            setArg(key2, next);
            i++;
          } else {
            setArg(key2, defaultValue(key2));
        ...
        if (!broken && key2 !== "-") {
          if (checkAllAliases(key2, flags.arrays)) {
            ...
            next = args[i + 1];
            if (next !== undefined && (!/^(-|--)[^-]/.test(next) || next.match(negative)) && !checkAllAliases(key2, flags.bools) && !checkAllAliases(key2, flags.counts)) {
              setArg(key2, next);
              i++;
            } else if (/^(true|false)$/.test(next)) {
              setArg(key2, next);
    ...
    function eatNargs(i, key2, args2, argAfterEqualSign) {
      ...
      if (toEat === 0) {
        if (!isUndefined(argAfterEqualSign)) {
          error2 = Error(__("Argument unexpected for: %s", key2));
        }
        setArg(key2, defaultValue(key2));
        return i;
      }
      ...
      if (configuration["nargs-eats-options"]) {
        if (args2.length - (i + 1) + available < toEat) {
          error2 = Error(__("Not enough arguments following: %s", key2));
        }
        available = toEat;
      } else {
    ...
    function applyDefaultsAndAliases(obj, aliases3, defaults2, canLog = false) {
      Object.keys(defaults2).forEach(function(key2) {
        if (!hasKey(obj, key2.split("."))) {
          ...
          if (canLog)
            defaulted[key2] = true;
          (aliases3[key2] || []).forEach(function(x) {
    ...
    function setKey(obj, keys, value) {
      ...
      keys.slice(0, -1).forEach(function(key3) {
        ...
        if (typeof o === "object" && o[key3] === undefined) {
          o[key3] = {};
        }
    ...
    function checkConfiguration() {
      Object.keys(flags.counts).find((key2) => {
        if (checkAllAliases(key2, flags.arrays)) {
          error2 = Error(__("Invalid configuration: %s, opts.count excludes opts.array.", key2));
          return true;
        } else if (checkAllAliases(key2, flags.nargs)) {
          error2 = Error(__("Invalid configuration: %s, opts.count excludes opts.narg.", key2));
          return true;
        }
        return false;
      });
